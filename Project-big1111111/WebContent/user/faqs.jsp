...
<body>
	...
	<div class="container main-container">
		<h3 class="main-heading2 nomargin-top"><i class="fa fa-pencil-square-o"></i> 经常问的问题</h3>
		<br>
		<p>
				...
				<div class="panel-heading">
					<h5 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion-faqs" href="#collapse1">
							<i class="fa fa-stethoscope"></i> 您在应用程序上提供的任何问题？
						</a>
					</h5>
				</div>
				<!-- End Panel Heading -->
				...
				<div class="panel-heading">
					<h5 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion-faqs" href="#collapse2">
							<i class="fa fa-stethoscope"></i> Opposed to using 'Content here, content here' ?
						</a>
					</h5>
				</div>
				<!-- End Panel Heading -->
				...
				<div class="panel-heading">
					<h5 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion-faqs" href="#collapse3">
							<i class="fa fa-stethoscope"></i> Readable content of a page when looking ?
						</a>
					</h5>
				</div>
				<!-- End Panel Heading -->
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-4 col-xs-6">
						...
						<ul class="list-unstyled">
							<li><a href="service-single.html"><i class="fa fa-angle-right"></i> 儿科诊所</a></li>
