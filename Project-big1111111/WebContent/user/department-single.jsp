	...
	<div class="breadcrumb">
		<div class="container">
			<ul class="list-unstyled list-inline">
				...
				<li><a href="departments.html">服务</a></li>
					...
					<article class="news-post">
						...
						<div class="inner">
							...
							<div class="news-post-content">
								<p>
									石棉肺病又称石棉沉着病，是人体长期吸入石棉尘后，致使肺组织弥漫性纤维化及胸膜增生为病理特征的损害。石棉是一种具用纤维状结构的硅酸盐矿物，含有镁和少量铁、钙、钠等。在开采及加工处理石棉的生产过程中，可形成大量粉尘,如防尘措施不力，可进入大气和水源污染环境，危害居民健康而成为公害。病程一般缓慢，临床上最早出现咳嗽、呼吸困难，且随活动而加剧的自觉症状；多为局部及一般性胸部疼痛，如为持续性疼痛则可能是胸膜问质瘤（接触石棉后并发的一种少见的肿瘤）的最早特征。
								</p>
								<p>
									石棉沉着病是由于在开采，加工，制造，使用（如作绝热用）或运输石棉制品中长期吸入石棉粉尘（含各种化学成分的纤维矿物硅酸盐）所引起。肺癌和间皮瘤的危险性与接触石棉纤维的累积时间有关。石棉有促进致癌的作用，但不是致癌始动剂。吸烟的石棉沉着病患者中肺癌的发生率增加，并有剂量-反应的关系。
								</p>
								<blockquote>
									<p>
										石棉沉着病患者早期可无症状及X线改变，或者仅有活动后气短。
隐匿症状出现多在接触粉尘7～10年以上，但少数也有仅在接触粉尘后1年左右即出现症状。石棉沉着病典型症状为缓慢出现、逐渐加重的呼吸困难，早期以劳力性为主，严重程度与接触粉尘的时间和浓度有关。一般为干咳，严重吸烟者咳嗽往往较重，且伴有黏液痰。胸痛往往较轻，常为背部或胸骨后钝痛，咯血较少见，如合并肿瘤可发生咯血，合并感染时有发热、咳脓痰。
									</p>
								</blockquote>
								<p>
									如何诊断是否为石棉沉着病呢？有石棉接触史的患者，根据其胸部X线或者CT检查所见的特征性改变，可以作出石棉沉着病的诊断。通常患者亦存在肺功能异常，听诊时可闻及啰喑。石棉沉着病的诊断必须进行活组织检查（取小块胸膜进行显微镜检查）。
								</p>
								<p>
									石棉沉着病的治疗主要是缓解症状，如采用氧疗或抽吸胸腔积液缓解呼吸困难等。有时，肺移植可成功地治疗石棉沉着病。如合并有胸膜间皮瘤，均为恶性，根据疾病分期，除适合手术切除的部分肿瘤患者外，其他患者可选择进行化疗和放疗。
								</p>
								<p>对于预防和缓解石棉病可采取：<br>
									1.工艺改革、革新生产设备：是消除粉尘危害的主要途径。<br>
									2.密闭、抽风、除尘：对不能采取湿式作业的场所，应采用密闭抽风除尘办法，防止粉尘飞扬。<br>
									3.个人防护：佩戴防尘护具，如防尘安全帽、送风头盔、送风口罩等。<br>
									食疗：多吃蔬菜和水果，例如猪血、雪梨、百合、西兰花、蜂蜜等清肺的食物，避免肥甘油腻等食物的摄入，避免辛辣刺激食物、烟酒、咖啡、浓茶等的刺激。有助于改善身体不适状况。
									医用药物：克矽平、汉防己甲素，中药，也可在临床医生具体指导下用些汉防已甲素，羟基哌哇，磷酸哌哇等。
									平时要多加锻炼。
							    </p>
								<!--<div class="row">
