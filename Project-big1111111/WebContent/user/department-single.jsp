					...
					<article class="news-post">
						...
						<div class="inner">
							...
							<div class="news-post-content">
								<h6>常见分类</h6>
								<p>
									1、中暑。在高温环境下，由于热平衡或水盐代谢紊乱而引起的一种以中枢神经系统或心血管系统障碍。<br>
									2、减压病 。在高气压下工作一定时间后，在转向正常气压时，因减压过速。<br>
									3、高原病 。人在低气压环境对缺氧不能适应。<br>
									4、航空病 。在高空环境中、由于气压下降、氧分压降低而导致的飞行人员缺氧。<br>
									5、手臂振动病。由于长期使用振动工具而引起的末梢循环障碍。
								</p>
								<h6>病因：</h6>
								<p>
									1、中暑 。在高温环境下，由于热平衡或水盐代谢紊乱而引起的一种以中枢神经系统或心血管系统障碍。<br>
								...
								<p>预防：<br>
									...
									1、中暑     中暑的预防，一是注意收听高温预报，合理安排作息时间。在高温天气，尤 其是每天１１－１４点，尽量减少外出，适当午睡，饮食宜清淡，多喝些淡盐开水、绿豆汤，每天勤洗澡、擦身。二是野外工作者、外出旅游、观看露天体育比赛，一定要带上防暑工具，如草帽、遮阳伞、太阳镜、仁丹、十滴水等，不要长时间在太阳下暴晒，注意到阴凉下休息，年老体弱者外出一定要有家人陪同。<br>
									2、减压病     1）对潜水员尤其新潜水员，要进行医学防治知识教育，使潜水员了解减压病的发病原因及预防方法。    2）养成良好卫生习惯，建立合理生活制度。工作前应充分休息，防止过度疲劳；不饮酒和少饮水。工作时应预防受寒和受潮。工作后应立即脱下潮湿的工作服，饮热茶，洗热水浴，在温暖的室内休息半小时以上，以促进血液循环，使体内多余的氮加速排出。    <br>
									3、高原病     进入高原人员应了解和适应高原环境特点，登山时按计划进行阶段性适应性锻炼，注意防寒和防治上呼吸道感染，久居平原重返高原者也应重建适应能力，应明显心、肺、血液疾病患者不宜进入高原。<br> 
									4、航空病       １）防晕机：晕机呕吐是平衡器官紊乱，身体适应较差的缘故，一般只要保持镇静，排除杂念，服些防晕车船药就会平安无事。    ２）防旧病突发：飞机起飞、降落、上升、下降、转弯、颠簸等飞行姿态的变化，以及飞机在穿越云层时光线明暗的快速变化，会刺激一些疾病发作。<br>
									5、手臂振动病    施工现场振动主要是有砼振动棒、风钻、打桩机、推土机、挖掘机等；主要受危害的工程有砼振动棒工、风钻工、打桩机司机、推土机司机、挖掘机司机等；预防措施有在振源与需要防振的设备之间，安装具有弹性性能的隔振装置，使振源产生的大部分振动被隔振装置所吸收；改革生产工艺，降低噪声；有些手持振动工具的手柄，包扎泡沫塑料等隔振垫，工人操作时戴好专用的防振手套，也可减少振动的危害。<br>
							    </p>
						...
						<div class="inner">
							...
							<div class="news-post-content">
								...
								<p>
										...
										1.职业皮炎：包括接触性皮肤炎、光接触性皮肤炎、电光性皮炎、放射性皮炎等。<br>
										2.职业性皮肤色素变化：职业性黑变病、职业性白斑、职业性痤疮、职业性皮肤溃疡、其他等。<br>
								...
								<p>对于预防和缓解可采取：<br>
									预防胜于治疗！雇主应尽可能提供完善的作业场所，如良好的通风、排水、灭菌消毒及废弃物处理系统，避免使员工暴露于可导致皮肤病变的环境中；若为不可避免之情况，则应提供适当的防护措施，如口罩、防毒面具、手套、袖套及遮阳帽等；
									另外应定期安排员工接受医师之检查。若发现有皮肤异常的情况，应及早就医诊治，以免延误病情！职业性皮肤病大部份虽然不会致命，但会使病患产生相当大的困扰，以致生产力降低并增加医疗支出，所以值得国人注意。
							    </p>
					...
					<article class="news-post">
						...
						<div class="inner">
							...
							<div class="news-post-content">
								<h6>简介：</h6>
								<p>
									职业性耳鼻喉所属耳科、鼻科、咽喉科。其中耳科包括噪声聋、耳鸣，鼻科包括铭鼻病、职业性鼻炎、鼻出血等。口腔科包含牙酸蚀病。
								</p>
								<h6>危害因素：</h6>
								<p>
									
										1.导致噪声聋的危害因素：噪声；<br>
										2.导致铬鼻病的危害因素：铬及其化合物、铬酸盐；<br>
										3.导致牙酸蚀病案的危害因素：氟化氰、硫酸酸雾、硝酸酸雾、盐酸酸雾；<br>
										
								</p>
								<blockquote>
									<p>
										对噪声性听力损伤目前仍无有效的治疗方法。当出现症状后应及时脱离噪声环境，停止噪声刺激，促使自然恢复，同时应强调及早治疗。常见的治疗药物如下：调节神经营养的药物，如维生素B类药物；血管扩张剂，如：葛根素、654-2、丹参、银杏叶、当归注射液等药物；
									促进代谢的生物制品，如：辅酶A等。耳鸣、眩晕者可对症治疗。针灸、理疗、压穴等方法可减轻症状。对听力损失达重度以上者可配戴助听器。
									</p>
								</blockquote>
								
								<h6>对于噪声聋预防：</h6>
								<p>
									1.在木工棚周围设密目网围挡，外围彩条布，在密目网内侧附草帘子，以便减小噪音对其他施工作业人员的搭设，在木工棚内的施工人员，应戴好护听器等防护用品。<br>
									2.工人支模拆除时教育工人轻拿轻放，减少噪音污染。 <br>
									3.使用切割机时工人必须戴好耳塞。<br>
									4.梁混凝土浇筑振捣时工人必须戴好耳塞或佩戴防噪音劳保用品。
							    </p>
