...
<body>
				...
				<div class="container">
					<div class="navbar-header">
						...
						<a href="index.html" class="navbar-brand">
							<img src="assets/images/logo.png" class="logo" alt="Logo"> 医院<span>检索系统</span>
						</a>
	...
	<div class="container main-container">
		<div class="block-404 text-center">
			<h2 class="text-uppercase"><span>4<i class="fa fa-exclamation-circle"></i>4</span></h2>
			<h5>您所寻找的页面不存在。</h5>
			<p>
				如果您是从书签来的，请记得更新您的书签。
			</p>
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-12 col-xs-12 newsletter-block">
						...
						<form action="#" class="newsletter">
							...
							<div class="form-group">
								<input type="email" class="form-control" placeholder="输入你的E-Mail">
							</div>
