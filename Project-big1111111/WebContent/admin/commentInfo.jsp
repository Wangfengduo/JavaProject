          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="${ctx}/admin/commentInfo">评论区列表</a></li>
                          <li><a class="" href="addComment.jsp">增加评论</a></li>
                          <li><a class="" href="${ctx}/admin/commentInfo">删除评论</a></li>
                      </ul>
                  </li>
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="icon_document_alt"></i>评论区	</li>
						<li><i class="fa fa-file-text-o"></i>评论区列表</li>
					</ol>
				</div>
			</div>
              <div class="row">
                      ...
                      <table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
						    ...
						    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
						  		<tr>
						   		 <td width="90%" align="left" valign="middle">
							         ...
							         <span>文章ID：</span>
							         <input type="text" name="id" value="根据文章ID查询" class="text-word" id="textfield" style="color:#999;font-style:italic;" 
							             onFocus="if (value =='根据文章ID查询'){value =''}" onBlur="if (value ==''){value='根据文章ID查询'}">
						  ...
						  <tr>
						    ...
						    <table  width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
						      <tr>
						        <th align="center" valign="middle" class="borderright">评论ID</th>
						      ...
						      <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
						        <td align="center" valign="middle" class="borderright borderbottom">${comment.id }</td>
						        <td align="center" valign="middle" class="borderright borderbottom">${comment.artical_id }</td>
						        <td align="center" valign="middle" class="borderright borderbottom">${comment.u_id }</td>
						        <td align="center" valign="middle" class="borderright borderbottom">${comment.content }</td>
						        <td align="center" valign="middle" class="borderright borderbottom">${comment.comment_time }</td>
						        <td align="center" valign="middle" class="borderright borderbottom"><a href="${ctx}/admin/deleteComment?id=${comment.id }">删除</a></td>
						      </tr>
						      </c:forEach>
						    </table>
						    </td>
