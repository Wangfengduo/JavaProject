...
<body style="background:url(img/bg.jpg) no-repeat;">
    ...
    <div class="container wrap1" style="height:450px;">
            <h2 class="mg-b20 text-center">养益生后台注册页面</h2>
            <div class="col-sm-8 col-md-5 center-auto pd-sm-50 pd-xs-20 main_content">
                <p class="text-center font16">用户注册</p>
                <form action="${ctx}/admin/register">
                    <div class="form-group mg-t20">
                        <i class="icon-user icon_font"></i>
                        <input name="username" type="text" class="login_input" id="text" placeholder="请输入用户名" />
                    </div>
                    <div class="form-group mg-t20">
                    ...
                    <button style="submit" class="login_btn">注册</button>
                    <input name="" type="reset" value="重置" class="login_btn" style="margin-top:20px;">
               </form>
        </div><!--row end-->
    </div><!--container end-->
